...
let showElevatorProductButtons = () => {
    navigation.breadcrumbArray[0] = ("<b>Elevator</b> >");
...
let showLandscapeAndPortraitProductButtons = () => {
    navigation.breadcrumbArray[0] = ("<b>Landscape and Portrait</b> >");
    navigation.manageBreadcrumbs();
    let eTarget = document.getElementById("productButtons__eButtons");
    let lpTarget = document.getElementById("productButtons__lpButtons");
...
function buttonClicked() {
    ...
    navigation.breadcrumbArray[1] = '<b>' + objectClicked.productFullName + '</b> >';
    navigation.manageBreadcrumbs();
    ...
    let destDiv = document.getElementById("filename__example_dyn");
